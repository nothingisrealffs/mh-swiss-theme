...
We are supposed to pay attention to:
 ...
 ### 1.Typographic Scale
    - Contrast between sizes of texts throughout the bodies of disparate tags
 ### 2.Whitespace and grid structure
    - Whitespace and Grid Structures are used to help guide reader's attention
 ### 3.Restrained Color Usage
    - Most professional editorial sites rely on neutral color pallets to keep focus
 ### 4.Article Card Patterns
    - Many publications organize information into card layouts that can contain any number of elements inside without breaking brand
